...
@Injectable()
@CommandHandler(VerifyResetCodeCommand)
export class VerifyResetCodeHandler
  implements ICommandHandler<VerifyResetCodeCommand, void>
{
  constructor(
  ...
  async execute(command: VerifyResetCodeCommand): Promise<void> {
